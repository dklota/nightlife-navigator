        ...
        <View style={styles.container}>
            ...
            <Animated.View
                style={[
                    styles.orb,
                    styles.orb1,
                    { opacity: orb1Op, transform: [{ translateY: orb1Y }] },
                ]}
            />
            <Animated.View
                style={[
                    styles.orb,
                    styles.orb2,
                    { opacity: orb2Op, transform: [{ translateY: orb2Y }] },
                ]}
            />
            <Animated.View
                style={[
                    styles.orb,
                    styles.orb3,
                    { opacity: 0.08, transform: [{ translateY: orb3Y }] },
                ]}
            />
            ...
            >
                ...
                <View style={styles.logoSection}>
                    ...
                    <Text style={styles.tagline}>where to move</Text>
                </View>
